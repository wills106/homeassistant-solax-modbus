...
SENSOR_TYPES_MAIN: list[SolaXModbusSensorEntityDescription] = [ 
    ...
    # PM S1 Inverter
    SolaXModbusSensorEntityDescription(
        name = "PM S1 ActivePower L1",
        key = "pm_s1_activepower_l1",
        native_unit_of_measurement = UnitOfPower.WATT,
        device_class = SensorDeviceClass.POWER,
        register = 0x204,
        register_type = REG_INPUT,
    ...
    SolaXModbusSensorEntityDescription(
        name = "PM S1 ActivePower L2",
        key = "pm_s1_activepower_l2",
        native_unit_of_measurement = UnitOfPower.WATT,
        device_class = SensorDeviceClass.POWER,
        register = 0x205,
        register_type = REG_INPUT,
    ...
    SolaXModbusSensorEntityDescription(
        name = "PM S1 ActivePower L3",
        key = "pm_s1_activepower_l3",
        native_unit_of_measurement = UnitOfPower.WATT,
        device_class = SensorDeviceClass.POWER,
        register = 0x206,
        register_type = REG_INPUT,
    ...
    SolaXModbusSensorEntityDescription(
        name = "PM S1 Reactive or ApparentPower L1",
        key = "pm_s1_reactive_or_apparentpower_l1",
        native_unit_of_measurement = UnitOfApparentPower.VOLT_AMPERE,
        device_class = SensorDeviceClass.APPARENT_POWER,
        register = 0x207,
        register_type = REG_INPUT,
    ...
    SolaXModbusSensorEntityDescription(
        name = "PM S1 Reactive or ApparentPower L2",
        key = "pm_s1_reactive_or_apparentpower_l2",
        native_unit_of_measurement = UnitOfApparentPower.VOLT_AMPERE, 
        device_class = SensorDeviceClass.APPARENT_POWER,
        register = 0x208,
        register_type = REG_INPUT,
    ...
    SolaXModbusSensorEntityDescription(
        name = "PM S1 Reactive or ApparentPower L3",
        key = "pm_s1_reactive_or_apparentpower_l3",
        native_unit_of_measurement = UnitOfApparentPower.VOLT_AMPERE, 
        device_class = SensorDeviceClass.APPARENT_POWER,
        register = 0x209,
        register_type = REG_INPUT,
    ...
    SolaXModbusSensorEntityDescription(
        name = "PM S1 Inverter Current L1",
        key = "pm_s1_current_l1",
        native_unit_of_measurement = UnitOfElectricCurrent.AMPERE,
        device_class = SensorDeviceClass.CURRENT,
        register = 0x20A,
        register_type = REG_INPUT,
    ...
    SolaXModbusSensorEntityDescription(
        name = "PM S1 Inverter Current L2",
        key = "pm_s1_current_l2",
        native_unit_of_measurement = UnitOfElectricCurrent.AMPERE,
        device_class = SensorDeviceClass.CURRENT,
        register = 0x20B,
        register_type = REG_INPUT,
    ...
    SolaXModbusSensorEntityDescription(
        name = "PM S1 Inverter Current L3",
        key = "pm_s1_current_l3",
        native_unit_of_measurement = UnitOfElectricCurrent.AMPERE,
        device_class = SensorDeviceClass.CURRENT,
        register = 0x20C,
        register_type = REG_INPUT,
    ...
    SolaXModbusSensorEntityDescription(
        name = "PM S1 PV Power 1",
        key = "pm_s1_pv_power_1",
        native_unit_of_measurement = UnitOfPower.WATT,
        device_class = SensorDeviceClass.POWER,
        state_class = SensorStateClass.MEASUREMENT,
        register = 0x20D,
    ...
    SolaXModbusSensorEntityDescription(
        name = "PM S1 PV Power 2",
        key = "pm_s1_pv_power_2",
        native_unit_of_measurement = UnitOfPower.WATT,
        device_class = SensorDeviceClass.POWER,
        state_class = SensorStateClass.MEASUREMENT,
        register = 0x20E,
    ...
    SolaXModbusSensorEntityDescription(
        name = "PM S1 PV Voltage 1",
        key = "pm_s1_pv_voltage_1",
        native_unit_of_measurement = UnitOfElectricPotential.VOLT,
        device_class = SensorDeviceClass.VOLTAGE,
        state_class = SensorStateClass.MEASUREMENT,
        register = 0x20F,
    ...
    SolaXModbusSensorEntityDescription(
        name = "PM S1 PV Voltage 2",
        key = "pm_s1_pv_voltage_2",
        native_unit_of_measurement = UnitOfElectricPotential.VOLT,
        device_class = SensorDeviceClass.VOLTAGE,
        state_class = SensorStateClass.MEASUREMENT,
        register = 0x210,
    ...
    SolaXModbusSensorEntityDescription(
        name = "PM S1 PV Current 1",
        key = "pm_s1_pv_current_1",
        native_unit_of_measurement = UnitOfElectricCurrent.AMPERE,
        device_class = SensorDeviceClass.CURRENT,
        register = 0x211,
        register_type = REG_INPUT,
    ...
    SolaXModbusSensorEntityDescription(
        name = "PM S1 PV Current 2",
        key = "pm_s1_pv_current_2",
        native_unit_of_measurement = UnitOfElectricCurrent.AMPERE,
        device_class = SensorDeviceClass.CURRENT,
        register = 0x212,
        register_type = REG_INPUT,
    ...
    SolaXModbusSensorEntityDescription(
        name = "PM S1 Battery Power Charge",
        key = "pm_s1_battery_power_charge",
        native_unit_of_measurement = UnitOfPower.WATT,
        device_class = SensorDeviceClass.POWER,
        state_class = SensorStateClass.MEASUREMENT,
        register = 0x213,
    ...
    SolaXModbusSensorEntityDescription(
        name = "PM S1 Battery Voltage Charge",
        key = "pm_s1_battery_voltage_charge",
        native_unit_of_measurement = UnitOfElectricPotential.VOLT,
        device_class = SensorDeviceClass.VOLTAGE,
        register = 0x214,
        scale = 0.1,
    ...
    SolaXModbusSensorEntityDescription(
        name = "PM S1 Battery Current Charge",
        key = "pm_s1_battery_current_charge",
        native_unit_of_measurement = UnitOfElectricCurrent.AMPERE,
        device_class = SensorDeviceClass.CURRENT,
        register = 0x215,
        scale = 0.1,
    ...
    SolaXModbusSensorEntityDescription(
        name = "PM S1 Battery Capacity",
        key = "pm_s1_battery_capacity_charge",
        native_unit_of_measurement = PERCENTAGE,
        device_class = SensorDeviceClass.BATTERY,
        register = 0x219,
        register_type = REG_INPUT,
    ...
    # PM S2 Inverter
    SolaXModbusSensorEntityDescription(
        name = "PM S2 ActivePower L1",
        key = "pm_s2_activepower_l1",
        native_unit_of_measurement = UnitOfPower.WATT,
        device_class = SensorDeviceClass.POWER,
        register = 0x21E,
        register_type = REG_INPUT,
    ...
    SolaXModbusSensorEntityDescription(
        name = "PM S2 ActivePower L2",
        key = "pm_s2_activepower_l2",
        native_unit_of_measurement = UnitOfPower.WATT,
        device_class = SensorDeviceClass.POWER,
        register = 0x21F,
        register_type = REG_INPUT,
    ...
    SolaXModbusSensorEntityDescription(
        name = "PM S2 ActivePower L3",
        key = "pm_s2_activepower_l3",
        native_unit_of_measurement = UnitOfPower.WATT,
        device_class = SensorDeviceClass.POWER,
        register = 0x220,
        register_type = REG_INPUT,
    ...
    SolaXModbusSensorEntityDescription(
        name = "PM S2 Reactive or ApparentPower L1",
        key = "pm_s2_reactive_or_apparentpower_l1",
        native_unit_of_measurement = UnitOfApparentPower.VOLT_AMPERE,
        device_class = SensorDeviceClass.APPARENT_POWER,
        register = 0x221,
        register_type = REG_INPUT,
    ...
    SolaXModbusSensorEntityDescription(
        name = "PM S2 Reactive or ApparentPower L2",
        key = "pm_s2_reactive_or_apparentpower_l2",
        native_unit_of_measurement = UnitOfApparentPower.VOLT_AMPERE, 
        device_class = SensorDeviceClass.APPARENT_POWER,
        register = 0x222,
        register_type = REG_INPUT,
    ...
    SolaXModbusSensorEntityDescription(
        name = "PM S2 Reactive or ApparentPower L3",
        key = "pm_s2_reactive_or_apparentpower_l3",
        native_unit_of_measurement = UnitOfApparentPower.VOLT_AMPERE, 
        device_class = SensorDeviceClass.APPARENT_POWER,
        register = 0x223,
        register_type = REG_INPUT,
    ...
    SolaXModbusSensorEntityDescription(
        name = "PM S2 Inverter Current L1",
        key = "pm_s2_current_l1",
        native_unit_of_measurement = UnitOfElectricCurrent.AMPERE,
        device_class = SensorDeviceClass.CURRENT,
        register = 0x224,
        register_type = REG_INPUT,
    ...
    SolaXModbusSensorEntityDescription(
        name = "PM S2 Inverter Current L2",
        key = "pm_s2_current_l2",
        native_unit_of_measurement = UnitOfElectricCurrent.AMPERE,
        device_class = SensorDeviceClass.CURRENT,
        register = 0x225,
        register_type = REG_INPUT,
    ...
    SolaXModbusSensorEntityDescription(
        name = "PM S2 Inverter Current L3",
        key = "pm_s2_current_l3",
        native_unit_of_measurement = UnitOfElectricCurrent.AMPERE,
        device_class = SensorDeviceClass.CURRENT,
        register = 0x226,
        register_type = REG_INPUT,
    ...
    SolaXModbusSensorEntityDescription(
        name = "PM S2 PV Power 1",
        key = "pm_s2_pv_power_1",
        native_unit_of_measurement = UnitOfPower.WATT,
        device_class = SensorDeviceClass.POWER,
        state_class = SensorStateClass.MEASUREMENT,
        register = 0x227,
    ...
    SolaXModbusSensorEntityDescription(
        name = "PM S2 PV Power 2",
        key = "pm_s2_pv_power_2",
        native_unit_of_measurement = UnitOfPower.WATT,
        device_class = SensorDeviceClass.POWER,
        state_class = SensorStateClass.MEASUREMENT,
        register = 0x228,
    ...
    SolaXModbusSensorEntityDescription(
        name = "PM S2 PV Voltage 1",
        key = "pm_s2_pv_voltage_1",
        native_unit_of_measurement = UnitOfElectricPotential.VOLT,
        device_class = SensorDeviceClass.VOLTAGE,
        state_class = SensorStateClass.MEASUREMENT,
        register = 0x229,
    ...
    SolaXModbusSensorEntityDescription(
        name = "PM S2 PV Voltage 2",
        key = "pm_s2_pv_voltage_2",
        native_unit_of_measurement = UnitOfElectricPotential.VOLT,
        device_class = SensorDeviceClass.VOLTAGE,
        state_class = SensorStateClass.MEASUREMENT,
        register = 0x22A,
    ...
    SolaXModbusSensorEntityDescription(
        name = "PM S2 PV Current 1",
        key = "pm_s2_pv_current_1",
        native_unit_of_measurement = UnitOfElectricCurrent.AMPERE,
        device_class = SensorDeviceClass.CURRENT,
        register = 0x22B,
        register_type = REG_INPUT,
    ...
    SolaXModbusSensorEntityDescription(
        name = "PM S2 PV Current 2",
        key = "pm_s2_pv_current_2",
        native_unit_of_measurement = UnitOfElectricCurrent.AMPERE,
        device_class = SensorDeviceClass.CURRENT,
        register = 0x22C,
        register_type = REG_INPUT,
    ...
    SolaXModbusSensorEntityDescription(
        name = "PM S2 Battery Power Charge",
        key = "pm_s2_battery_power_charge",
        native_unit_of_measurement = UnitOfPower.WATT,
        device_class = SensorDeviceClass.POWER,
        state_class = SensorStateClass.MEASUREMENT,
        register = 0x22D,
    ...
    SolaXModbusSensorEntityDescription(
        name = "PM S2 Battery Voltage Charge",
        key = "pm_s2_battery_voltage_charge",
        native_unit_of_measurement = UnitOfElectricPotential.VOLT,
        device_class = SensorDeviceClass.VOLTAGE,
        register = 0x22E,
        scale = 0.1,
    ...
    SolaXModbusSensorEntityDescription(
        name = "PM S2 Battery Current Charge",
        key = "pm_s2_battery_current_charge",
        native_unit_of_measurement = UnitOfElectricCurrent.AMPERE,
        device_class = SensorDeviceClass.CURRENT,
        register = 0x22F,
        scale = 0.1,
    ...
    SolaXModbusSensorEntityDescription(
        name = "PM S2 Battery Capacity",
        key = "pm_s2_battery_capacity_charge",
        native_unit_of_measurement = PERCENTAGE,
        device_class = SensorDeviceClass.BATTERY,
        register = 0x233,
        register_type = REG_INPUT,
