...
def value_function_timingmode(initval, descr, datadict):
    return  [ ('timed_charge_start_h', datadict.get('timed_charge_start_h', datadict.get('ro_timed_charge_start_h')), ),
              ('timed_charge_start_m', datadict.get('timed_charge_start_m', datadict.get('ro_timed_charge_start_m')), ),
              ('timed_charge_end_h', datadict.get('timed_charge_end_h', datadict.get('ro_timed_charge_end_h')), ),
              ('timed_charge_end_m', datadict.get('timed_charge_end_m', datadict.get('ro_timed_charge_end_m')), ),
              ('timed_discharge_start_h', datadict.get('timed_discharge_start_h', datadict.get('ro_timed_discharge_start_h')), ),
              ('timed_discharge_start_m', datadict.get('timed_discharge_start_m', datadict.get('ro_timed_discharge_start_m')), ),
              ('timed_discharge_end_h', datadict.get('timed_discharge_end_h', datadict.get('ro_timed_discharge_end_h')), ),
              ('timed_discharge_end_m', datadict.get('timed_discharge_end_m', datadict.get('ro_timed_discharge_end_m')), ),
            ]
