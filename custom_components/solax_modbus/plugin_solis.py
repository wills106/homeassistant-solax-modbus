...
def determineInverterType(hub, configdict):
    ...
    if seriesnumber.startswith('1031'):  invertertype = HYBRID | X1 # Hybrid Gen5 3104 Model
...
###
    ...
    SolisModbusSensorEntityDescription(
        name="Meter AC Voltage R",
        key="meter_ac_voltage_r",
        native_unit_of_measurement=ELECTRIC_POTENTIAL_VOLT,
        device_class=DEVICE_CLASS_VOLTAGE,
        register = 33251,
        register_type = REG_INPUT,
    ...
    SolisModbusSensorEntityDescription(
        name="Meter AC Current R",
        key="meter_ac_current_r",
        native_unit_of_measurement=ELECTRIC_CURRENT_AMPERE,
        device_class=DEVICE_CLASS_CURRENT,
        register = 33252,
        register_type = REG_INPUT,
    ...
    SolisModbusSensorEntityDescription(
        name="Meter AC Voltage S",
        key="meter_ac_voltage_s",
        native_unit_of_measurement=ELECTRIC_POTENTIAL_VOLT,
        device_class=DEVICE_CLASS_VOLTAGE,
        register = 33253,
        register_type = REG_INPUT,
    ...
    SolisModbusSensorEntityDescription(
        name="Meter AC Current S",
        key="meter_ac_current_s",
        native_unit_of_measurement=ELECTRIC_CURRENT_AMPERE,
        device_class=DEVICE_CLASS_CURRENT,
        register = 33254,
        register_type = REG_INPUT,
    ...
    SolisModbusSensorEntityDescription(
        name="Meter AC Voltage T",
        key="meter_ac_voltage_t",
        native_unit_of_measurement=ELECTRIC_POTENTIAL_VOLT,
        device_class=DEVICE_CLASS_VOLTAGE,
        register = 33255,
        register_type = REG_INPUT,
    ...
    SolisModbusSensorEntityDescription(
        name="Meter AC Current T",
        key="meter_ac_current_t",
        native_unit_of_measurement=ELECTRIC_CURRENT_AMPERE,
        device_class=DEVICE_CLASS_CURRENT,
        register = 33256,
        register_type = REG_INPUT,
    ...
    SolisModbusSensorEntityDescription(
        name = "Meter ReactivePower",
        key = "meter_reactivepower",
        native_unit_of_measurement = POWER_VOLT_AMPERE_REACTIVE,
        device_class = DEVICE_CLASS_POWER,
        register = 33265,
        register_type = REG_INPUT,
    ...
    SolisModbusSensorEntityDescription(
        name = "Meter ReactivePower Total",
        key = "meter_reactivepower_total",
        native_unit_of_measurement = POWER_VOLT_AMPERE_REACTIVE,
        device_class = DEVICE_CLASS_POWER,
        register = 33271,
        register_type = REG_INPUT,
    ...
    SolisModbusSensorEntityDescription(
        name = "Meter ApparentPower",
        key = "meter_apparentpower",
        native_unit_of_measurement=POWER_VOLT_AMPERE,
        device_class = DEVICE_CLASS_POWER,
        register = 33273,
        register_type = REG_INPUT,
    ...
    SolisModbusSensorEntityDescription(
        name = "Meter ApparentPower Total",
        key = "meter_apparentpower_total",
        native_unit_of_measurement=POWER_VOLT_AMPERE,
        device_class = DEVICE_CLASS_POWER,
        register = 33279,
        register_type = REG_INPUT,
    ...
    SolisModbusSensorEntityDescription(
        name = "Meter PowerFactor",
        key = "meter_powerfactor",
