...
def value_function_time_slot_1_reverse_enabled(initval, descr, datadict):
    time_1_enabled = datadict.get('register_3038_read', 0) # need to use a read entity to avoid overwriting the select
...
def value_function_time_slot_1_reverse_mode(initval, descr, datadict):
    time_1_mode = datadict.get('register_3038_read', 0)
...
SENSOR_TYPES: list[GrowattModbusSensorEntityDescription] = [
    ...
    GrowattModbusSensorEntityDescription(
        ...
        scale = 0.1,
        rounding = 1,
        allowedtypes = GEN | GEN2 | ALL_MPPT_GROUP,
    ),
    GrowattModbusSensorEntityDescription(
        name = "PV Current 3",
        key = "pv_current_3",
    ...
    GrowattModbusSensorEntityDescription(
        ...
        scale = 0.1,
        rounding = 1,
        allowedtypes = GEN | GEN2 | MPPT4 | MPPT6 | MPPT8 | MPPT10,
    ),
    GrowattModbusSensorEntityDescription(
        name = "PV Current 4",
        key = "pv_current_4",
    ...
    GrowattModbusSensorEntityDescription(
        ...
        scale = 0.1,
        rounding = 1,
        allowedtypes = GEN | GEN2 | MPPT6 | MPPT8 | MPPT10,
    ),
    GrowattModbusSensorEntityDescription(
        name = "PV Current 5",
        key = "pv_current_5",
    ...
    GrowattModbusSensorEntityDescription(
        ...
        scale = 0.1,
        rounding = 1,
        allowedtypes = GEN | GEN2 | MPPT8 | MPPT10,
    ),
    GrowattModbusSensorEntityDescription(
        name = "PV Current 7",
        key = "pv_current_7",
    ...
    GrowattModbusSensorEntityDescription(
        ...
        scale = 0.1,
        rounding = 1,
        allowedtypes = GEN | GEN2 | X3 | ALL_MPPT_GROUP,
        entity_registry_enabled_default = False,
        icon = "mdi:solar-power",
    ),
    GrowattModbusSensorEntityDescription(
    ...
    GrowattModbusSensorEntityDescription(
        ...
        scale = 0.1,
        rounding = 1,
        allowedtypes = GEN | GEN2 | X3 | MPPT4 | MPPT6 | MPPT8 | MPPT10,
        entity_registry_enabled_default = False,
        icon = "mdi:solar-power",
    ),
    GrowattModbusSensorEntityDescription(
    ...
    GrowattModbusSensorEntityDescription(
        ...
        scale = 0.1,
        rounding = 1,
        allowedtypes = GEN | GEN2 | X3 | MPPT6 | MPPT8 | MPPT10,
        entity_registry_enabled_default = False,
        icon = "mdi:solar-power",
    ),
    GrowattModbusSensorEntityDescription(
    ...
    GrowattModbusSensorEntityDescription(
        ...
        scale = 0.1,
        rounding = 1,
        allowedtypes = GEN | GEN2 | X3 | MPPT8 | MPPT10,
        entity_registry_enabled_default = False,
        icon = "mdi:solar-power",
    ),
    GrowattModbusSensorEntityDescription(
...
#    ),
    ...
    GrowattModbusSensorEntityDescription(
        ...
        scale = 0.1,
        rounding = 1,
        allowedtypes = GEN3 | ALL_MPPT_GROUP,
    ),
    GrowattModbusSensorEntityDescription(
        name = "PV Current 3",
        key = "pv_current_3",
...
class growatt_plugin(plugin_base):
    ...
    async def async_determineInverterType(self, hub, configdict):
        ...
        if seriesnumber.startswith('GH1'):  invertertype = PV | GEN3 | X1 # PV TL-X 2.5kW - 6kW (MIN)
        elif seriesnumber.startswith('AL1'):  invertertype = HYBRID | GEN3 | X1 # Hybrid TL-XH 2.5kW - 6kW (MIN)
        elif seriesnumber.startswith('DHA'):  invertertype = PV | GEN | X3 # PV TL3-SL 15-22kW #1067
        elif seriesnumber.startswith('DL1'):  invertertype = PV | GEN | X3 # PV TL3-X 15kW 3Phase (MOD)
        elif seriesnumber.startswith('DM1'):  invertertype = PV | GEN | X3 | MPPT4 # PV TL3-X 35kW 3Phase (MID)
