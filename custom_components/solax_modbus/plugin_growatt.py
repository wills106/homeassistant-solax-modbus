...
SELECT_TYPES = [
    ...
    GrowattModbusSelectEntityDescription(
        name = "Grid Stop Time 1",
        key = "grid_stop_time_1",
        register = 1081,
        option_dict = TIME_OPTIONS,
        allowedtypes = HYBRID | AC | GEN,
        entity_category = EntityCategory.CONFIG,
    ...
    GrowattModbusSelectEntityDescription(
        name = "Grid Stop Time 2",
        key = "grid_stop_time_2",
        register = 1084,
        option_dict = TIME_OPTIONS,
        allowedtypes = HYBRID | AC | GEN,
        entity_category = EntityCategory.CONFIG,
    ...
    GrowattModbusSelectEntityDescription(
        name = "Grid Stop Time 3",
        key = "grid_stop_time_3",
        register = 1087,
        option_dict = TIME_OPTIONS,
        allowedtypes = HYBRID | AC | GEN,
        entity_category = EntityCategory.CONFIG,
    ...
    GrowattModbusSelectEntityDescription(
        name = "Charger Stop Time 3",
        key = "charger_stop_time_3",
        register = 1107,
        option_dict = TIME_OPTIONS,
        allowedtypes = HYBRID | AC | GEN,
        entity_category = EntityCategory.CONFIG,
