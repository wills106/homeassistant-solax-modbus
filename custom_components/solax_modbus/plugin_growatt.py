...
SENSOR_TYPES: list[GrowattModbusSensorEntityDescription] = [
    ...
    GrowattModbusSensorEntityDescription(
        ...
        key="run_mode",
        register=1000,
        scale={0: "Waiting", 1: "Self Test", 2: "2, ?", 3: "Permanent Fault Mode", 4: "Update Mode", 5: "PV Bat Online", 6: "Bat Online", 7: "7, ?", 8: "Normal Mode", 9: "Bypass"},
        register_type=REG_INPUT,
        allowedtypes=GEN3,
        icon="mdi:run",
    ),
    ...
    GrowattModbusSensorEntityDescription(
        ...
        register_type=REG_INPUT,
        unit=REGISTER_U16,
        scale={0: "Dormancy", 1: "Charging", 2: "Discharging", 3: "Free", 4: "Standby", 5: "Soft start", 6: "Fault", 7: "Updating"},
        allowedtypes=GEN4 | HYBRID,
        entity_registry_enabled_default=True,
        icon="mdi:battery",
    ),
