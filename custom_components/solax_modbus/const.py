...
class plugin_base:
    ...
    auto_default_scangroup: str = SCAN_GROUP_DEFAULT, # only used when default_xxx_scangroup is set to SCAN_GROUP_AUTO
    auto_slow_scangroup: str = SCAN_GROUP_MEDIUM, # only used when default_xxx_scangroup is set to SCAN_GROUP_AUTO
